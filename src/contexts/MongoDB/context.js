...
//string de conexion
const connection = mongoose.connect('mongodb+srv://enzo:coder123@clustercoderback.a4dyco9.mongodb.net/?retryWrites=true&w=majority',error=>{
...
class contenedor {
    ...
    save = async({title,price,thumbnail,stock})=>{
        try {
            ...
            return (`producto agregado con exito. ${{title,price,thumbnail,stock}} `)
        } catch (error) {
            console.log(error)
        }
    }
